...
@section('title-header', 'Ubah Pengeluaran')
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Pengeluaran</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date " class="form-control @error('bulan') is-invalid @enderror" id="bulan"
                                        placeholder="Input Bulan" value="{{ $pengeluaran->bulan }}" name="bulan">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('pengeluaran') is-invalid @enderror"
                                        id="pengeluaran" placeholder="Input Pengeluaran" value="{{ $pengeluaran->pengeluaran }}" name="pengeluaran">
